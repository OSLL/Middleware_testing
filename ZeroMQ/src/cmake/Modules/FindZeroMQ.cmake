...
find_library (ZeroMQ_LIBRARIES NAMES zmq libzmq.a libzmq.lib HINTS ${ZeroMQ_ROOT_DIR}/lib)
...
if (ZEROMQ_FOUND)
  ...
  message (FATAL_ERROR "Could not find the ZeroMQ libraries! Please install the development-libraries and headers.")
endif (ZEROMQ_FOUND)
