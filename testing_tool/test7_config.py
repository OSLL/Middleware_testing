...
def test7_config():
    configs = []
    mkdir_config(7)
    args = {"topic":'test_topic', "res_filenames":['pub', 'sub'], "m_count":3300, "min_msg_size":-896, "max_msg_size":2097152,  "step":64*1024, "msgs_before_step":100, "priority":[99, 99], "cpu_index":[0, 1], "interval":0, "topic_priority":100}
